<?php
/*****************************************************/
/** Registering all the Advanced Custom Fields via PHP
/*****************************************************/
...
acf_add_local_field_group(array (
  ...
  'fields' => array (
    array (
      ...
      'name' => 'page_title_and_decription',
      'type' => 'tab',
      'instructions' => '',
      'required' => 0,
      'conditional_logic' => 0,
...
acf_add_local_field_group(array (
  ...
  'title' => 'Meet the Maker Image Carousel',
  'fields' => array (
    array (
      'key' => 'field_572294df144ec',
      'label' => 'Image Carousel',
      'name' => 'mtm_image_carousel',
      'type' => 'gallery',
      'instructions' => 'Up to 5 images can be added. Images look best when uploaded when sized at 1200px wide by 1200px height, but the carousel will do its best to fit any size image to fit.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
...
acf_add_local_field_group(array (
  ...
  'fields' => array (
    array (
      ...
      'name' => 'you_cannot_edit_this_post_feed_page_it_automatically_displays_a_feed_of_all_your_posts',
      'type' => 'message',
      'instructions' => '',
      'required' => 0,
      'conditional_logic' => 0,
...
acf_add_local_field_group(array (
  ...
  'fields' => array (
    array (
      ...
      'label' => 'You cannot edit this schedule page from here. Edit it with Gravity Forms.',
      'name' => 'you_cannot_edit_this_schedule_page_from_here_it_automatically_displays_a_feed_of_all_your_posts',
      'type' => 'message',
      'instructions' => '',
      'required' => 0,
      'conditional_logic' => 0,
      ...
      'layouts' => array (
        ...
        array (
          ...
          'sub_fields' => array (
            ...
            array (
              'key' => 'field_5715192f22ba2',
              'label' => 'Sub Title',
              'name' => 'sub_title_sponsor_panel',
              'type' => 'text',
              'instructions' => 'Optional description. 40 character limit.',
              'required' => 0,
              'conditional_logic' => 0,
              'wrapper' => array (
                'width' => '',
              ...
              'default_value' => '',
              'placeholder' => '2016 Maker Faire Sponsors:',
              'prepend' => '',
              'append' => '',
              'maxlength' => 40,
              'readonly' => 0,
        ...
        array (
          ...
          'sub_fields' => array (
            ...
            array (
              ...
              'name' => 'images',
              'type' => 'repeater',
              'instructions' => 'Minimum of 3 image. Max 10 images.',
              'required' => 1,
              'conditional_logic' => 0,
              'wrapper' => array (
                'width' => '',
