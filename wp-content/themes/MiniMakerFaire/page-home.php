...
<section class="slideshow-panel">
	...
	<div class="header-logo-div text-center" itemprop="event" itemscope
      ...
      if ($faire_location_url) :
         ?>
        <a class="event-location-url"
			href="<?php echo $faire_location_url ?>"
			<?php if($open_faire_location){ echo ' target="_blank"';} ?>>
      <?php endif;
      
      if ($faire_location) :
         ?>
        <h2 class="event-location" itemprop="location">
				<i class="fa fa-map-marker" aria-hidden="true"></i><?php echo $faire_location ?></h2><?php
      endif;
      ...
      if ($faire_date) :
         ?>
        <h2 class="event-date" itemprop="startDate">
			<i class="fa fa-calendar-o" aria-hidden="true"></i><?php echo $faire_date ?></h2> <?php
      endif;
      ...
      <div class="header-logo-cont">
			<img class="img-responsive header-logo"
				src="<?php echo legacy_get_fit_remote_image_url( $header_logo, 750, 750); ?>"
         ...
         if ($i == 0) {
            ?>
              <div class="item active">
				<img src="<?php echo $photon; ?>"
					alt="<?php if($image['alt'] != ''){echo $image['alt'];}else{echo 'Maker Faire featured image';} ?>" />
			</div> <?php
         } else {
            ?>
              <div class="item">
      ...
      ?>
        ...
        <?php if( $i > 1 ): ?>
          <a class="left carousel-control" href="#myCarousel"
			role="button" data-slide="prev"> <img class="glyphicon-chevron-right"
			src="<?php echo get_bloginfo('template_directory');?>/img/arrow_left.png"
			alt="Image Carousel button left" /> <span class="sr-only">Previous</span>
		</a> <a class="right carousel-control" href="#myCarousel"
			role="button" data-slide="next"> <img class="glyphicon-chevron-right"
			src="<?php echo get_bloginfo('template_directory');?>/img/arrow_right.png"
			alt="Image Carousel button right" /> <span class="sr-only">Next</span>
		</a>
        <?php endif; ?>
      </div>
	<!-- /.carousel -->
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-4 text-center">
				<a href="<?php echo $url1;?>" target="_blank"> <img
					src="<?php echo get_site_option( 'find-out-more-img1' ); ?>"
					alt="<?php _e('Click here to get subscriptions to Make: Magazine','MiniMakerFaire');?>"
					class="img-responsive" />
				</a>
			</div>
			<div class="col-xs-6 col-sm-6 col-md-4 text-center">
				<a href="<?php echo $url2;?>" target="_blank"> <img
					src="<?php echo get_site_option( 'find-out-more-img2' ); ?>"
					alt="<?php _e('Click here to see our global Maker Faires','MiniMakerFaire');?>"
					class="img-responsive" />
				</a>
			</div>
