<?php
  ...
  if( have_rows('content_panels')) {
    ...
    while ( have_rows('content_panels') ) {
      ...
      ///////////////////////////////////////
      //  STATIC FEATURED MAKERS (SQUARE)  //
      //          STATIC                   //
      ///////////////////////////////////////
      if( $row_layout == 'featured_makers_panel' ) {
      ...
      //          DYNAMIC                   //
      ////////////////////////////////////////
      } elseif( $row_layout == 'featured_makers_panel_dynamic' ) {
      ...
      ///////////////////////////////////////
      //  STATIC FEATURED MAKERS (CIRCLE)  //
      //          STATIC                   //
      ///////////////////////////////////////
      } elseif( $row_layout == 'featured_makers_panel_circle' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active' ) {
          $makers_to_show = get_sub_field('makers_to_show');
          $more_makers_button = get_sub_field('more_makers_button');
      ...
      //          DYNAMIC                   //
      ////////////////////////////////////////
      } elseif( $row_layout == 'featured_makers_panel_circle_dynamic' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active' ) {
          $more_makers_button = get_sub_field('more_makers_button');
          $formid = get_sub_field('enter_formid_here');
      ...
      //        STATIC           //
      /////////////////////////////
      } elseif( $row_layout == 'featured_events' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active' ) {
          $more_makers_button = get_sub_field('more_makers_button');
      ...
      //        DYNAMIC           //
      //////////////////////////////
      } elseif( $row_layout == 'featured_events_dynamic' ) {
        $activeinactive = get_sub_field('activeinactive');
      ...
      //   2 COLUMN LAYOUT    //
      //////////////////////////
      } elseif( $row_layout == '2_column_photo_and_text_panel' ) {
        $activeinactive = get_sub_field('activeinactive');
      ...
      /////////////////////////////////
      } elseif( $row_layout == 'what_is_maker_faire' ) {
      ...
      //  CTA PANEL  //
      /////////////////
      } elseif( $row_layout == 'call_to_action_panel' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active' ) {
      ...
      //////////////////////////////////
      } elseif( $row_layout == 'static_or_carousel' ) {
        $activeinactive = get_sub_field('activeinactive');
      ...
      //////////////////////////////////
      } elseif( $row_layout == 'square_image_carousel' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active') {
          $width = get_sub_field('width');
        ...
        } //end active panel check

      ///////////////////////////
      //  NEWSLETTER PANEL     //
      ///////////////////////////
      } elseif( $row_layout == 'newsletter_panel' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active') { ?>
      ...
      //  SPONSOR PANEL     //
      ////////////////////////
      } elseif( $row_layout == 'sponsors_panel' ) {
        $activeinactive = get_sub_field('activeinactive');
        if( $activeinactive == 'Active') {
          ...
          } //End have rows sponsors
        } //End active/inactive sponsors
      } //End flex content. Get row layout.
    } //end while have content panels
  } else {
    // no layout found
  }
